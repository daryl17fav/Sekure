...
import '../navigation/bindings/buyer_order_details_binding.dart';
import '../modules/buyer_order_details/views/buyer_order_details_view.dart';
import '../navigation/bindings/buyer_orders_list_binding.dart';
import '../modules/buyer_orders_list/views/buyer_orders_list_view.dart';
import '../navigation/bindings/create_dispute_binding.dart';
import '../modules/create_dispute/views/create_dispute_view.dart';
import '../navigation/bindings/create_order_binding.dart';
import '../modules/create_order/views/create_order_view.dart';
import '../navigation/bindings/create_password_binding.dart';
import '../modules/create_password/views/create_password_view.dart';
import '../navigation/bindings/create_submission_binding.dart';
import '../modules/create_submission/views/create_submission_view.dart';
import '../navigation/bindings/disputes_binding.dart';
import '../modules/disputes/views/disputes_view.dart';
import '../navigation/bindings/face_id_binding.dart';
import '../modules/face_id/views/face_id_view.dart';
import '../navigation/bindings/forgot_password_binding.dart';
import '../modules/forgot_password/views/forgot_password_view.dart';
import '../navigation/bindings/home_binding.dart';
import '../modules/home/views/home_view.dart';
import '../navigation/bindings/home_buyer_binding.dart';
import '../modules/home_buyer/views/home_buyer_view.dart';
import '../navigation/bindings/login_binding.dart';
import '../modules/login/views/login_view.dart';
import '../navigation/bindings/loyalty_points_binding.dart';
import '../modules/loyalty_points/views/loyalty_points_view.dart';
import '../navigation/bindings/my_orders_binding.dart';
import '../modules/my_orders/views/my_orders_view.dart';
import '../navigation/bindings/notification_detail_binding.dart';
import '../modules/notification_detail/views/notification_detail_view.dart';
import '../navigation/bindings/notifications_binding.dart';
import '../modules/notifications/views/notifications_view.dart';
import '../navigation/bindings/order_details_binding.dart';
import '../modules/order_details/views/order_details_view.dart';
import '../navigation/bindings/order_tracking_binding.dart';
import '../modules/order_tracking/views/order_tracking_view.dart';
import '../navigation/bindings/orders_binding.dart';
import '../modules/orders/views/orders_view.dart';
import '../navigation/bindings/payment_binding.dart';
import '../modules/payment/views/payment_view.dart';
import '../navigation/bindings/register_binding.dart';
import '../modules/register/views/register_view.dart';
import '../navigation/bindings/register_seller_binding.dart';
import '../modules/register_seller/views/register_seller_view.dart';
import '../navigation/bindings/role_selection_binding.dart';
import '../modules/role_selection/views/role_selection_view.dart';
import '../navigation/bindings/splash_binding.dart';
import '../modules/splash/views/splash_view.dart';
import '../navigation/bindings/submissions_binding.dart';
import '../modules/submissions/views/submissions_view.dart';
import '../navigation/bindings/touch_id_auth_binding.dart';
import '../modules/touch_id_auth/views/touch_id_auth_view.dart';
import '../navigation/bindings/touch_id_verify_binding.dart';
import '../modules/touch_id_verify/views/touch_id_verify_view.dart';
import '../navigation/bindings/verification_binding.dart';
